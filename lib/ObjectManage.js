...
ObjectManage.prototype.save = function(cb){
  ...
  if('function' === typeof self.driver.save){
    ...
    cb('driver (' + self.driver.name + ') has not implemented a save method')
  }
}
 ...
 * @param handle
 */
ObjectManage.prototype.restore = function(handle){
  var self = this
  ...
  if('function' === typeof self.driver.restore){
    ...
    throw new Error('driver (' + self.driver.name + ') has not implemented a restore method')
  }
}
 ...
 */
ObjectManage.prototype.flush = function(){
  var self = this
  if(null === self.handle){
    ...
    throw new Error('driver (' + self.driver.name + ') has not implemented a flush method')
  }
}
