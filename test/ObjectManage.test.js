...
describe('ObjectManage',function(){
  ...
  describe('Construction',function(){
    it('should accept data to the constructor',function(){
      ...
      expect(obj.test1).to.equal('val1')
      expect(obj.test2).to.equal('val2')
    })
    it('should be able to merge in data after constructing',function(){
      var obj = new ObjectManage(data1,data2)
      expect(obj.test3).to.equal('val3')
      expect(obj.test4).to.equal('val4')
    })
  })

  describe('Static methods',function(){
    it('should be able to clone an existing object',function(){
      var obj = ObjectManage.$clone(data1)
      expect(obj.test1).to.equal('val1')
    })
    it('should be able to extract internals from ObjectManage',function(){
      var obj1 = new ObjectManage(data1)
      var int = ObjectManage.$extract(obj1)
      expect(int.$e).to.be.instanceof(EventEmitter)
    })
    it('should be able to clone ObjectManage objects',function(){
      var obj1 = new ObjectManage(data1)
      var obj2 = ObjectManage.$clone(obj1)
      expect(obj2.$get('test1')).to.equal('val1')
    })
    it('should be able to extend an existing object',function(){
      var obj = ObjectManage.$clone(data1)
      obj = ObjectManage.$extend(obj)
      expect(obj.$get('test1')).to.equal('val1')
    })
  ...
  describe('Setters and Getters',function(){
    ...
    it('should be able to set a nested key',function(){
      ...
      expect(obj.test5.test7).to.equal('val7')
    })
    it('should overwrite a key to object if nested below',function(){
      ...
      expect(obj.test5.test6.new).to.equal('val8')
    })
  ...
  describe('Removal and Existence',function(){
    ...
    it('should remove a property and all its children',function(){
      var obj = new ObjectManage(data1,data2,data3)
      obj.$remove('test5')
      expect(obj.hasOwnProperty('test5')).to.equal(false)
    })
    ...
    it('should hand back only the data using strip',function(){
      var obj = new ObjectManage(data1)
      obj = obj.$strip()
      expect(obj.test1).to.equal('val1')
    })
  ...
  describe('Events',function(){
    ...
    it('should emit a set event',function(done){
      var obj = new ObjectManage()
      obj.$e.once('set',function(path,value){
    ...
    it('should emit a get event',function(done){
      var obj = new ObjectManage(data1)
      obj.$e.once('get',function(path,value){
    ...
    it('should emit an exists event',function(done){
      var obj = new ObjectManage(data1)
      obj.$e.once('exists',function(path,exists){
        expect(path).to.equal('foo')
    ...
    it('should emit a remove event',function(done){
      var obj = new ObjectManage(data1)
      obj.$e.once('remove',function(path,removed){
        expect(path).to.equal('test1')
  ...
  describe('Set with Validation',function(){
    it('should validate using drop',function(done){
      ...
      obj.$e.once('drop',function(verb,message,path,value){
    ...
    it('should validate using reject',function(done){
      ...
      obj.$e.once('reject',function(verb,message,path,value){
        expect(verb).to.equal('set')
        expect(message).to.equal('test1 must be set to val2')
        expect(path).to.equal('test1')
        expect(value).to.equal('val3')
    ...
    it('should validate using warn',function(done){
      ...
      obj.$e.once('warn',function(verb,message,path,value){
        expect(verb).to.equal('set')
        expect(message).to.equal('test1 must be set to val2')
        expect(path).to.equal('test1')
        expect(value).to.equal('val3')
    ...
    it('should validate using error',function(done){
      ...
      obj.$e.once('error',function(verb,message,path,value){
        expect(verb).to.equal('set')
        expect(message).to.equal('test1 must be set to val2')
        expect(path).to.equal('test1')
        expect(value).to.equal('val3')
  ...
  describe('Storage Drivers',function(){
    ...
    describe('Storage Events',function(){
      it('should emit a generateHandle event',function(done){
        var obj = new ObjectManage()
        obj.$e.once('generateHandle',function(handle){
          expect(handle).to.not.equal(null)
          done()
        })
        obj.$generateHandle()
      ...
      it('should emit a save event',function(done){
        var obj = new ObjectManage()
        obj.$e.once('save',function(handle,data){
          expect(handle).to.not.equal(null)
          expect(data.foo).to.equal('yes')
          done()
        })
      ...
      it('should emit a restore event',function(done){
        ...
        obj1.$save(function(err,handle){
          if(err) throw err
          var obj = new ObjectManage()
          obj.$e.once('restore',function(err,data){
            if(err) throw err
            expect(data.foo).to.equal('yes')
            done()
          })
